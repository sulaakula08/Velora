...
import { submitClassroomWorkTool, listClassroomCoursesTool, createClassroomAssignmentTool } from './classroom';
...
export const tools: Tool[] = [
  ...
  listClassroomCoursesTool,
  createClassroomAssignmentTool,
];
